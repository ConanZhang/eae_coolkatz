...
namespace eae_coolkatz.Gameplay
{
    public class Goal
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            if(isAngel)
            {
                victoryGate.Draw(spriteBatch, ConvertUnits.ToDisplayUnits(goalSensor.Position), goalSensor.Rotation, victoryGate.flipHorizontally);
            }
            else
            {
                victoryGate.Draw(spriteBatch, ConvertUnits.ToDisplayUnits(goalSensor.Position.X + 9, goalSensor.Position.Y), goalSensor.Rotation, victoryGate.flipHorizontally);
            }
